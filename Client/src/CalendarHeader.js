   ...
   //  eventEmitter = new EventEmitter();
    ...
    componentDidMount() {
      //this.eventEmitter = new EventEmitter();
        ...
        this.props.eventEmitter.emit('month-change', { month:this.state.selectedMonth});
      }
    ...
    getNextMonth(){
        ...
        if(index === 11){
            ...
            this.setState((prevState,props)=>{return{selectedMonth:prevState.months[newIndex]}},() =>  this.props.eventEmitter.emit('month-change', {month: this.state.selectedMonth}))
        }
    };
    getPreviousMonth(){
        var index = this.state.months.indexOf(this.state.selectedMonth);
        ...
        if(index === 0){
            this.setState((prevState,props)=>{return{selectedMonth:prevState.months[11]}}, () =>  this.props.eventEmitter.emit('month-change', {month: this.state.selectedMonth}))
            this.setState((prevState,props)=>{return{selectedYear:(prevState.selectedYear - 1)}}, () => this.props.eventEmitter.emit('year-change', {year:this.state.selectedYear}));
        } 
        else{
            var newIndex = index - 1;
            this.setState((prevState,props)=>{return{selectedMonth:prevState.months[newIndex]}}, () =>  this.props.eventEmitter.emit('month-change', {month: this.state.selectedMonth}))
